...
public class RollEventBox extends FormController<List<RollEvent>> {
    ...
    TextField multPlayersDamageField;
    ...
    public Node getContent() {
        ...
        Label multPlayersDamageLabel = new Label("multPlayersDamage");
        ...
        multPlayersDamageField = new TextField();
        multPlayersDamageField.setPromptText("[0,127");
        ...
        modPlayerButton.setOnAction(e -> DialogFactory.instance().showAttributeModifierBox(modifier));
        ...
        rollEventButton.setOnAction(e -> DialogFactory.instance().showRollEventModifierBox(rollEvents));
        damageLinkCheckBox = new CheckBox();
        discardRandomItemCheckBox = new CheckBox();
        putOnMonsterSlotCheckBox = new CheckBox();

        FXUtil.initNumberFields(multRewardField, multPlayersDamageField, modMonsterDamageField, multMonsterDamageField,
                damageField, modRollField, modAttackField, healMonsterField, expandMonsterField,
                discardLootField, discardCentsField, peekDeckAmountField, soulHitPointsField,
                rerollItemField, modMonstersAttackRollField);
