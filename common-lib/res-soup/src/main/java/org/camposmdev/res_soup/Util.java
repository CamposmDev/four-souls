...
import static org.camposmdev.res_soup.FileNames.DAT_DIR;

public class Util {
    public static void saveMetaCards(String des, List<MetaCard> cards) {
        try {
    ...
    public static void writeObject(File f, List<MetaCard> cards) {
        try {
