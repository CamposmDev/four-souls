...
public class MonsterForm extends FormController<MonsterCard> {
    ...
    private PassiveEvent buildPassiveEvent() {
        ...
        event.setTimerEater(pe_isTimerEater.isSelected());
        ...
        event.setRollListeners(pe_rollListeners.toArray(new RollListener[]{}));
        event.setPreattackRollEvents(pe_preattackRollEvents.toArray(new RollEvent[]{}));
        return event;
    }
    ...
    private DeathEvent buildDeathEvent() {
        ...
        // Setting roll events
        deathEvent.setDeathRollEvents(de_deathRollEvents.toArray(new RollEvent[]{}));
        deathEvent.setKillRollEvents(de_killRollEvents.toArray(new RollEvent[]{}));
